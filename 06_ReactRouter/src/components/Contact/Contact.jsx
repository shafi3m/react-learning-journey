...
export default function Contact() {
  return (
    <div className="relative flex items-top justify-center min-h-[500px] bg-white sm:items-center sm:pt-0 animate-fade-in">
      <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div className="mt-8 overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Contact Info */}
            <div className="p-6 mr-2 bg-gray-100 sm:rounded-lg animate-fade-in-up">
            ...
            {/* Contact Form */}
            <form className="p-6 flex flex-col justify-center animate-fade-in-up">
